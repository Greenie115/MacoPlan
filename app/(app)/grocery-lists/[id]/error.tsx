...
export default function GroceryListError({
  error,
  reset,
}: {
  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center bg-background p-4">
      <div className="max-w-md text-center space-y-6">
        ...
        <h1 className="text-2xl font-bold text-foreground">Couldn&apos;t load this list</h1>
        <p className="text-muted-foreground">
          Something went wrong loading your shopping list. Please try again.
        </p>
