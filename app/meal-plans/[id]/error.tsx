  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center bg-background p-4">
      <div className="max-w-md text-center space-y-6">
        ...
        <h1 className="text-2xl font-bold text-foreground">Couldn&apos;t load this plan</h1>
        <p className="text-muted-foreground">
          Something went wrong loading your meal plan. Try again, or head back to your plans.
        </p>
