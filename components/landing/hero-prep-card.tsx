...
export function HeroPrepCard() {
  return (
    <div className="relative max-w-md mx-auto lg:mx-0 lg:ml-auto">
      {/* Calorie badge */}
      <div
        className="float-slow absolute -top-5 -right-3 sm:-right-6 z-20 bg-primary text-primary-foreground text-sm font-bold px-4 py-2 rounded-full shadow-lg shadow-primary/30 [--float-rot:3deg]"
      ...
      <div className="relative z-10 bg-white text-charcoal rounded-3xl p-6 sm:p-7 shadow-2xl shadow-black/40 ring-1 ring-white/10">
        ...
        <div className="flex items-start justify-between mb-5">
          <div>
            <p className="text-[11px] font-bold uppercase tracking-[0.14em] text-primary">Sunday prep plan</p>
        ...
        {/* Footer chips */}
        <div className="flex flex-wrap gap-2 text-[11px] font-semibold text-charcoal/60">
