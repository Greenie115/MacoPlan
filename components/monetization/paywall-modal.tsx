...
export function PaywallModal({ isOpen, onClose }: PaywallModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-200">
        {/* Close Button */}
        <button 
          onClick={onClose}
        ...
        <div className="p-6 flex flex-col items-center text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">You&apos;ve reached your limit</h2>
          <p className="text-gray-600 mb-8">
            You&apos;ve used all 3 free meal plans. Upgrade to Premium for unlimited plans and more features.
          </p>
          ...
          <div className="w-full space-y-4 mb-8 text-left">
            ...
            {/* Annual Plan */}
            <div className="relative w-full border-2 border-primary bg-primary/5 rounded-xl p-4 cursor-pointer hover:bg-primary/10 transition-colors">
              ...
              <button className="w-full h-12 flex items-center justify-center gap-2 rounded-lg bg-primary text-white font-bold hover:bg-primary/90 transition-colors">
                Subscribe Annual
            ...
            {/* Monthly Plan */}
            <div className="w-full border border-gray-200 rounded-xl p-4 cursor-pointer hover:border-gray-300 transition-colors">
              <div className="flex justify-between items-center mb-1">
              ...
              <button className="w-full h-12 flex items-center justify-center gap-2 rounded-lg bg-gray-100 text-gray-900 font-bold hover:bg-gray-200 transition-colors">
                Subscribe Monthly
              </button>
            </div>
          </div>
